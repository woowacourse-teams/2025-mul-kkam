...
import mulkkam.shared.generated.resources.weight_complete
import mulkkam.shared.generated.resources.weight_label
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(resource = Res.string.weight_label),
                    style = MulKkamTheme.typography.title1,
                    color = Black,
                )

                Icon(
                    painter = painterResource(resource = Res.drawable.ic_bio_info_weight_close),
            ...
            Button(
                ...
                Text(
                    text = stringResource(resource = Res.string.weight_complete),
