...
import mulkkam.shared.generated.resources.setting_cups_toolbar_back_btn_description
...
fun CupsTopAppBar(onBackClick: () -> Unit) {
    Column {
        CenterAlignedTopAppBar(
            title = {
                Text(
                    text = stringResource(Res.string.setting_cups_toolbar_title),
            ...
            navigationIcon = {
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(Res.string.setting_cups_toolbar_back_btn_description),
                    )
                }
            },
            colors =
