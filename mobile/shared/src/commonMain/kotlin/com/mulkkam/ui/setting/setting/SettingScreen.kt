...
fun SettingScreen(navigateToSettingType: (SettingType) -> Unit) {
    val settingItems =
        listOf(
            SettingItem.TitleItem(stringResource(Res.string.setting_section_account)),
            SettingItem.NormalItem(
                stringResource(Res.string.setting_nickname_edit_nickname_label),
                SettingType.NICKNAME,
            ),
            SettingItem.NormalItem(
                stringResource(Res.string.setting_item_body_info),
                SettingType.BODY_INFO,
            ),
            SettingItem.NormalItem(
                stringResource(Res.string.setting_item_account_info),
                SettingType.ACCOUNT_INFO,
            ),
            SettingItem.DividerItem,
            SettingItem.TitleItem(stringResource(Res.string.setting_section_water)),
            SettingItem.NormalItem(
                stringResource(Res.string.setting_cups_toolbar_title),
                SettingType.MY_CUP,
            ),
            SettingItem.NormalItem(
                stringResource(Res.string.setting_target_amount_toolbar_title),
                SettingType.GOAL,
            ),
            SettingItem.DividerItem,
            SettingItem.TitleItem(stringResource(Res.string.setting_section_notification)),
            SettingItem.NormalItem(
                stringResource(Res.string.setting_item_push_notification),
                SettingType.PUSH_NOTIFICATION,
            ),
            SettingItem.NormalItem(
                stringResource(Res.string.setting_reminder_toolbar_title),
                SettingType.REMINDER,
            ),
            SettingItem.DividerItem,
            SettingItem.TitleItem(stringResource(Res.string.setting_section_support)),
            SettingItem.NormalItem(
                stringResource(Res.string.setting_item_feedback),
                SettingType.FEEDBACK,
            ),
            SettingItem.NormalItem(stringResource(Res.string.setting_item_terms), SettingType.TERMS),
        )
