...
class MemberServiceIntegrationTest extends ServiceIntegrationTest {
    ...
    class modifyPhysicalAttributes {
        ...
        void success_validDataAllArgs() {
            ...
            assertSoftly(softly -> {
                softly.assertThat(modifiedMember.getGender()).isEqualTo(gender);
                softly.assertThat(modifiedMember.getWeight()).isEqualTo(weight);
            });
        }
        ...
        void success_validDataSomeArgs() {
            ...
            assertSoftly(softly -> {
                softly.assertThat(modifiedMember.getGender()).isEqualTo(member.getGender());
                softly.assertThat(modifiedMember.getWeight()).isEqualTo(weight);
            });
        }
    }
