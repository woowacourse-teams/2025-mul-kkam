...
public class AuthController {
    ...
    @ApiResponse(responseCode = "400", description = "잘못된 카카오 액세스 토큰", content = @Content(schema = @Schema(implementation = backend.mulkkam.common.exception.FailureBody.class), examples = {
