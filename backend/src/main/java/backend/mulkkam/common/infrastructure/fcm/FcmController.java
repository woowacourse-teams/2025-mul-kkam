...
public class FcmController {
    ...
    @ApiResponse(responseCode = "500", description = "FCM 서버 오류", content = @Content(schema = @Schema(implementation = FailureBody.class), examples = {
            @ExampleObject(name = "FCM 서버 오류", summary = "외부 서비스 실패", value = "{\"code\":\"SEND_MESSAGE_FAILED\"}")
    }))
